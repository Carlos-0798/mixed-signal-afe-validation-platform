...
| SW-NFR-004 | VERIFIED_HOST | 单元、黄金、架构、adapter/workflow、runners、分析、导出、serial stack、产品 CLI/report/Dashboard/demo 和 public adapter 默认无需硬件；当前本地门禁完成 2,277 项回归和 11,911/11,911 三 package 语句覆盖，fresh base/serial 安装、双 demo、hosted matrix、tester journey 和 external adapter 均有可重复证据 | 较新的交互/展示/治理提交仍须推送后重跑 hosted CI；保持物理 HIL 为可选路径 |
