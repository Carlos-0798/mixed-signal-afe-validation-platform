...
| Tk availability becomes a base-package installation dependency | Current Windows environment imports Tk 8.6 only | Lazy Dashboard import, headless CLI/base-wheel tests, clear missing-Tk guidance, and separate real-window smoke; import success is not UI completion evidence |
