...
**Current milestone:** Software Phase 6 release engineering — 4 of 8 checkpoints<br>
...
| mypy | Passed on `src`, `tools`, and `tests` — 195 source/tool/test files |
...
Software Phase 6 Steps 1–4 are complete. The next checkpoint is the beginner
installation/tester/troubleshooting/feedback documentation and private-beta
test checklist. Public-adapter proof, final audit, and owner-approved GitHub
