...
**Phase 0 only: design, idealized LTspice checks, synthetic telemetry, and host-side tests.** No breadboard, PCB, MSP430 firmware, instrument measurement, electrical limit, accuracy target, or hardware behavior has been verified.
...
python -m pytest
python tools/telemetry_simulator.py --count 5
python tools/synthetic_sweep_generator.py --points 21
```
